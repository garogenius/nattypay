              ...
              {activeStep === 0 && (
                <>
                  ...
                  >
                    ...
                    {currencyState && (
                      <div
                        className="absolute top-full my-2.5 px-1 py-2 overflow-y-scroll overscroll-contain h-fit max-h-[80vh] w-full bg-bg-600 border dark:bg-bg-1100 border-gray-300 dark:border-border-600 rounded-md shadow-md z-50 touch-pan-y pointer-events-auto"
