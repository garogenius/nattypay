...
import {
  ...
  useVerifyEmailPreRegister,
} from "@/api/auth/auth.queries";

const PreRegisterVerifyEmailContent = () => {
  ...
  } = useResendVerifyEmailPreRegister(onResendError, onResendSuccess);
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg">
            ...
            <p className="text-sm text-gray-600 mb-6">
              Enter the 6-digit code sent to <span className="font-medium">{authEmail || "your email"}</span>
            </p>
...
export default PreRegisterVerifyEmailContent;
