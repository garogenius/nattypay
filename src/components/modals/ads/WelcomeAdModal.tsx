      ...
      >
        ...
        <div className="relative z-10 p-4 sm:p-6 md:p-8">
          ...
          <div className="text-center mb-4 sm:mb-6">
            <div className="inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full bg-[#D4B139]/20 mb-3 sm:mb-4 animate-bounce">
              <FiGlobe className="text-2xl sm:text-2xl md:text-3xl text-[#D4B139]" />
            </div>
